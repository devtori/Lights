...
public class t_NumberLock : MonoBehaviour
{
    ...
    {
        numberSprites = Resources.LoadAll<Sprite>("Sprites/t_numbers");
    }
    ...
    void LayerManager()
    {
        ...
        if (displayImage.GetComponent<t_DisplayImage>().CurrentState == t_DisplayImage.State.normal)
        {
